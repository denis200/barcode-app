...
export default function RegScreen({ navigation }) {
    return (
      <View>
        ...
        <TextInput placeholder = "Имя" maxLength={32} autoCorrect={false} style = {styles.input}></TextInput>
        <TextInput placeholder = "Дата Рождения" maxLength={32} autoCorrect={false} style = {styles.input}></TextInput>
        <TextInput placeholder = "Email" maxLength={32} autoCorrect={false} style = {styles.input}></TextInput>
        <TextInput placeholder = "Телефон" maxLength={32} autoCorrect={false} style = {styles.input}></TextInput>
        <TextInput secureTextEntry = {true} placeholder = "Пароль" maxLength={32} autoCorrect={false} style = {styles.input}></TextInput>
